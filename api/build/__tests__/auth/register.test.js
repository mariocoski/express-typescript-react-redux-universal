    ...
    it('should fail to create a user without input', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    expectError(response, errors_1.EMAIL_IS_REQUIRED);
                    return [2 /*return*/];
            }
        });
    }); });
    it('should fail to create a user when email is invalid', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    expectError(response, errors_1.EMAIL_IS_INVALID);
                    return [2 /*return*/];
            }
        });
    }); });
    it('should fail to create a user without password', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    expectError(response, errors_1.PASSWORD_IS_REQUIRED);
                    return [2 /*return*/];
            }
        });
    }); });
    it('should fail to create a user without password', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    expectError(response, errors_1.PASSWORD_IS_TOO_SHORT);
                    return [2 /*return*/];
            }
        });
    }); });
